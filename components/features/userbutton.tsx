...
const Userbutton = () => {
  ...
  return (
    ...
    <div onClick={trigger} className='flex bg-white items-center  text-sm  border justify-between p-2 cursor-pointer gap-1.5 min-h-12 border-neutral-200 rounded-md'>
        <div className="flex items-center gap-1.5">
          <Image src={'/icons/user-Profile.png'} className='w-10 h-10 bg-neutral-200 rounded-full' width={1000} height={1000} alt='profile' />
